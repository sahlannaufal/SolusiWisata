...
function CardArmada({item}) {
  return (
          <div key={item.id} className=' w-56 rounded-3xl border-2'>
              ...
              <div className='space-y-4 mx-8 my-4'>
                <div className='space-y-1'>
                  <p className='font-semibold text-base leading-tight text-center'>{item.merk} ({item.jenis})</p>
                      <ul class="list-disc text-base text-gray-600">
                          <li>{item.seat} seat</li>
                          <li>{item.fitur}</li>
                          <li>Tarif (Rp.{item.harga})</li>
                      </ul>
                </div>
