  ...
  return (
    <div className='container mx-auto py-8 px-4 md:px-0'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
        {paket.map(paket => (
          <div key={paket.id} className='border rounded-lg p-4 shadow-md'>
            <h2 className='text-2xl font-bold mb-2'>{paket.destinasi}</h2>
            <p className='text-gray-600 mb-4'>{paket.harga}</p>
            <Link href={`/armada/${paket.id}`}>
